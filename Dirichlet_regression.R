...
env_allpops<-abs(rbind.data.frame(pop1, pop2, pop3, pop4, pop5)) ### getting a stan error that dirichlet predictors need to be positive. Not sure why that would be (worth running down, but doing this for now to try to get the model to work)
...
x<-hierarchical_data[,6:10]
y<-hierarchical_data[,1:5]
